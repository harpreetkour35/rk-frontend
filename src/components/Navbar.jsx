...
export const Navbar = () => {
  return (
    <header className="header sticky top-0 bg-white shadow-xl flex items-center justify-between px-8 py-02 z-40">
      <h1 className="w-3/12">RUDRA KUSH</h1>
      ...
      <div className="w-3/12 bg-red flex justify-end gap-x-4">
        <Link to="cart">
          <svg
